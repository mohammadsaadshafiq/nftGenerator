        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 3:
              ...
              _context9.next = _context9.t0 === 'openUrl' ? 8 : _context9.t0 === 'web3Transaction' ? 11 : _context9.t0 === 'web3Sign' ? 24 : _context9.t0 === 'callPluginEndpoint' ? 41 : 63;
              break;
            ...
            case 8:
              ...
              return _context9.abrupt("break", 64);
            ...
            case 13:
              ...
              _context9.next = 16;
              return _regenerator.default.awrap(this.web3.eth.sendTransaction((_triggersArray$i8 = triggersArray[i]) == null ? void 0 : _triggersArray$i8.data));

            case 16:
              response = _context9.sent;

            case 17:
              if (((_triggersArray$i9 = triggersArray[i]) == null ? void 0 : _triggersArray$i9.shouldAwait) === false) response = this.web3.eth.sendTransaction((_triggersArray$i10 = triggersArray[i]) == null ? void 0 : _triggersArray$i10.data);
              if (((_triggersArray$i11 = triggersArray[i]) == null ? void 0 : _triggersArray$i11.saveResponse) === true) this.memoryCard.save(response);
            ...
            case 34:
              if (((_triggersArray$i15 = triggersArray[i]) == null ? void 0 : _triggersArray$i15.shouldAwait) === false) response = this.web3.eth.personal.sign(triggersArray[i].message, triggersArray[i].signer);
              if (((_triggersArray$i16 = triggersArray[i]) == null ? void 0 : _triggersArray$i16.saveResponse) === true) this.memoryCard.save(response);
            ...
            case 55:
              if (((_triggersArray$i21 = triggersArray[i]) == null ? void 0 : _triggersArray$i21.saveResponse) === true) this.memoryCard.save(response);
              ...
              return _context9.abrupt("continue", 64);
